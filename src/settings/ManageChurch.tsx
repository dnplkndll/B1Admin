...
import { Lock as LockIcon, PlayArrow as PlayArrowIcon, Edit as EditIcon, History as HistoryIcon, Webhook as WebhookIcon, Code as CodeIcon } from "@mui/icons-material";
      ...
      <PageHeader title={church.data?.name || Locale.label("settings.manageChurch.title")} subtitle={church.data?.subDomain ? `${church.data.subDomain}.b1.church` : Locale.label("settings.manageChurch.subtitle")}>
        <Stack direction="row" spacing={1}>
          ...
          <Button
            ...
            {Locale.label("settings.developer.title")}
          </Button>
          <Button
            variant="outlined"
