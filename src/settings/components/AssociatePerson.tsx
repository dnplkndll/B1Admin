        ...
        <TableRow>
          ...
          {showChangeOption && (
            <TableCell className="border-0">
              <Button size="small" variant="outlined" startIcon={<PersonIcon />} data-cy="change-person" onClick={handleChangeClick}>{Locale.label("settings.associatePerson.change")}</Button>
            </TableCell>
          )}
        </TableRow>
      </TableBody>
